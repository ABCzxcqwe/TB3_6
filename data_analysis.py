...
def ejecutar_analisis_completo():
    df = cargar_datos()
    conocer_datos(df)
    metricas_descriptivas(df)
    visualizar_datos(df)
    funcionalidades_extra(df)
    print("\n  ✔ Analisis completado. Graficos guardados en assets/")
